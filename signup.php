...
<div class="container">
      ...
      <div  class="form">
        <form id="contactform" method="POST"> 
          <p class="contact"><label for="name">Nombre y Apellido</label></p> 
          <input id="name" name="name" placeholder="Nombre y apellido" required="" tabindex="1" type="text" value="<?php if(isset($_POST['signup'])) { echo $_POST['name']; } ?>"> 
           
          <p class="contact"><label for="email">correo electronico</label></p> 
          <input id="email" name="email" placeholder="ejemplo@domain.com" required="" type="email" value="<?php if(isset($_POST['signup'])) { echo $_POST['email']; } ?>"> 
                
                <p class="contact"><label for="username">Crear un nombre de usuario</label></p> 
          ...
          <input type="password" id="password" name="password" required=""> 
                <p class="contact"><label for="repassword">Confirmar la contraseña</label></p> 
          <input type="password" id="repassword" name="repassword" required=""> 
        
            <p class="contact"><label for="gender">Genero </label></p> 
            <select class="select-style gender" name="gender">
            <option value="Male">Masculino</option>
            <option value="Female">Femenino</option>
            </select><br><br>
            
            <p class="contact"><label for="role">Soy un..</label></p> 
            <select class="select-style gender" name="role">
            <option value="teacher">Estudiante</option>
            <option value="student">Profesor</option>
            </select><br><br>
            
            <p class="contact"><label for="course">Yo enseño / estudio ...</label></p>
            <select class="select-style gender" name="course">
            <option value="Computer Science">Cienca de la computación</option>
            <option value="Electrical">Ingeniería eléctrica</option>
            <option value="Mechanical">Ingeniería mecánica</option>
            <option value="Informatica">Ingeniería Informatica</option>
            <option value="Medicina">Medicina</option>
            <option value="Odontólogia">Odontología</option>
            <option value="Secundaria">Escuela Secundaria</option>
            <option value="Primaria">Escuela Primaria</option>
            <option value="otros">otros nivel o carrera universitaria</option>
            </select><br><br>
            
            <input class="buttom" name="signup" id="submit" tabindex="5" value="¡Inscríbeme!" type="submit">    
   </form> 
</div>      
</div>
